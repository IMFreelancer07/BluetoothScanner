...
//            TextView deviceAdress = (TextView) convertView.findViewById(R.id.tvDeviceAddress);
            TextView datetime = (TextView) convertView.findViewById(R.id.tvDateTime2);
            ...
            if (deviceName != null) {
                ...
                dbAdapter.insertData("timing point 3", device.getName(), time, NAME_NOT_SYNCED_WITH_SERVER);
            }
