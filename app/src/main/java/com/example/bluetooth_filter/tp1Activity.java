...
import com.example.bluetooth_filter.Adapters.DeviceListAdapter;
...
public class tp1Activity extends AppCompatActivity {
    ...
    private final BroadcastReceiver mBroadcastReceiver3 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothDevice.ACTION_FOUND)) {
                ...
                mDeviceListAdapter = new DeviceListAdapter(context, R.layout.bt_adapter, mBTDevices);
...
//        unregisterReceiver(mBroadcastReceiver3);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.timing_point1);
