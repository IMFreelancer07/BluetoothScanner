...
import com.example.bluetooth_filter.Adapters.DeviceListAdapter1;
...
public class tp2Activity extends AppCompatActivity {
    ...
    public DeviceListAdapter1 mDeviceListAdapter;
    ...
    private BroadcastReceiver mBroadcastReceiver4 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothDevice.ACTION_FOUND)) {
                ...
                mDeviceListAdapter = new DeviceListAdapter1(context, R.layout.bt_adapter1, mBTDevices);
...
//         unregisterReceiver(mBroadcastReceiver4);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.timing_point2);
        ...
        bt_switch = (Switch) findViewById(R.id.bt_switch1);
