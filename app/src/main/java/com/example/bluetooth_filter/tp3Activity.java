...
import com.example.bluetooth_filter.Adapters.DeviceListAdapter2;
...
public class tp3Activity extends AppCompatActivity {
    ...
    public DeviceListAdapter2 mDeviceListAdapter;
    ...
    private BroadcastReceiver mBroadcastReceiver5 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothDevice.ACTION_FOUND)) {
                ...
                mDeviceListAdapter = new DeviceListAdapter2(context, R.layout.bt_adapter2, mBTDevices);
...
//        unregisterReceiver(mBroadcastReceiver3);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.timing_point3);
        ...
        bt_switch = (Switch) findViewById(R.id.bt_switch2);
...
//        }
    ...
    public void btnDiscover() {
        ...
        if (mBluetoothAdapter.isDiscovering()) {
            ...
            registerReceiver(mBroadcastReceiver5, discoverDevicesIntent);
        }
        if (!mBluetoothAdapter.isDiscovering()) {
