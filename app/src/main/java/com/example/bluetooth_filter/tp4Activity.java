...
import com.example.bluetooth_filter.Adapters.DeviceListAdapter3;
...
public class tp4Activity extends AppCompatActivity {
    ...
    public DeviceListAdapter3 mDeviceListAdapter;
    ...
    private BroadcastReceiver mBroadcastReceiver6 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothDevice.ACTION_FOUND)) {
                ...
                mDeviceListAdapter = new DeviceListAdapter3(context, R.layout.bt_adapter3, mBTDevices);
...
//        unregisterReceiver(mBroadcastReceiver6);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.timing_point4);


        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);

        lvNewDevices = (ListView) findViewById(R.id.lvNewDevices3);
        ...
        bt_switch = (Switch) findViewById(R.id.bt_switch3);
...
//        }
    ...
    public void btnDiscover() {
        ...
        if (mBluetoothAdapter.isDiscovering()) {
            ...
            registerReceiver(mBroadcastReceiver6, discoverDevicesIntent);
        }
        if (!mBluetoothAdapter.isDiscovering()) {
