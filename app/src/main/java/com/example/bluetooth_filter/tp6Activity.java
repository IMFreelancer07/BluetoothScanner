...
import com.example.bluetooth_filter.Adapters.DeviceListAdapter5;
...
public class tp6Activity extends AppCompatActivity {
    ...
    public DeviceListAdapter5 mDeviceListAdapter;
     ...
     */
    private BroadcastReceiver mBroadcastReceiver8 = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            final String action = intent.getAction();
            ...
            if (action.equals(BluetoothDevice.ACTION_FOUND)) {
                ...
                mDeviceListAdapter = new DeviceListAdapter5(context, R.layout.bt_adapter5, mBTDevices);
...
//        unregisterReceiver(mBroadcastReceiver8);
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.timing_point6);

        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);

        lvNewDevices = (ListView) findViewById(R.id.lvNewDevices5);
        ...
        bt_switch = (Switch) findViewById(R.id.bt_switch5);
...
//        }
    ...
    public void btnDiscover() {
        ...
        if (mBluetoothAdapter.isDiscovering()) {
            ...
            registerReceiver(mBroadcastReceiver8, discoverDevicesIntent);
        }
        if (!mBluetoothAdapter.isDiscovering()) {
